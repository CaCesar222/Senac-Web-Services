package com.senac.ads4.atv_04_10.handler;

import com.senac.ads4.atv_04_10.exception.CustomHttpException;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    private ErrorResponse createErrorResponse(HttpStatus status, String message, String stackTrace, Object data) {
        return new com.senac.ads4.atv_04_10.handler.ErrorResponse(status, message, stackTrace, data);
    }
